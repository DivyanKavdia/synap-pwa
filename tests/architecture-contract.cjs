...
assert(enhancements.includes("SHELL_REVISION='1.0.0-shell157-chakshu-voice8'"),'update-notice generation must match the service worker');
...
assert(sw.includes("const CACHE_REVISION='1.0.0-shell157-chakshu-voice8';"),'service worker revision must advance with the architecture graph');
