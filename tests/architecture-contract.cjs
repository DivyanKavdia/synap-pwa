...
assert(enhancements.includes("SHELL_REVISION='1.0.0-shell104-chakshu-player'"),'update-notice generation must match the service worker');
...
assert(sw.includes("const CACHE_REVISION='1.0.0-shell104-chakshu-player';"),'service worker revision must advance with the architecture graph');
