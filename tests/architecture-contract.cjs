...
assert(enhancements.includes("SHELL_REVISION='1.0.0-shell74-compact'"),'update-notice generation must match the service worker');
...
assert(sw.includes("const CACHE_REVISION='1.0.0-shell74-compact';"),'service worker revision must advance with the architecture graph');
