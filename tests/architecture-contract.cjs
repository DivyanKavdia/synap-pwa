...
assert(enhancements.includes("SHELL_REVISION='1.0.0-shell151-single-owner-sd-sync'"),'update-notice generation must match the service worker');
...
assert(sw.includes("const CACHE_REVISION='1.0.0-shell151-single-owner-sd-sync';"),'service worker revision must advance with the architecture graph');
