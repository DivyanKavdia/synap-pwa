...
assert(enhancements.includes("SHELL_REVISION='1.0.0-shell156-offline-cue'"),'update-notice generation must match the service worker');
...
assert(sw.includes("const CACHE_REVISION='1.0.0-shell156-offline-cue';"),'service worker revision must advance with the architecture graph');
