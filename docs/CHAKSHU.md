...
The current app revision is `1.0.0-shell122-chakshu` with capture UI revision `1.0.0-chakshu-core7`. A PWA reload updates the app; it does not flash the pendant.
