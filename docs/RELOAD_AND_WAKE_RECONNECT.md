...
- Once a handshake has started, a visibility change alone does not cancel it. See the subsequent [recording stability repair](RECORDING_CONNECTION_STABILITY.md) for delayed GATT requests and disconnect diagnostics.
