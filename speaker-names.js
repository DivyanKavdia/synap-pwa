...
(function(root){
  ...
  function attach(card,recording){
    ...
    details.innerHTML='<summary>Edit speaker identity</summary><p class="speaker-names-hint">Confirm or correct names, then save to update summaries. Choose That’s me for your own speaker, then save. Use a clear pendant sample to improve future recognition. Leave a name blank to restore its label.</p><form><fieldset class="speaker-name-fields"></fieldset><div class="speaker-name-actions"><button type="submit">Save identity & refresh transcript</button><button type="button" class="speaker-names-reload">Reload speakers</button></div></form><p class="speaker-names-status" role="status" aria-live="polite"></p><details class="known-speakers"><summary>Remembered voices</summary><p class="speaker-names-hint">Encrypted and private to your account. Removing a voice stops future matching; existing memories stay unchanged.</p><div class="known-speaker-list"></div></details>';
