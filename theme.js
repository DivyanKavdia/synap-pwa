...
(function(){
  ...
  const SHELL_REVISION='1.0.0-day-audio1';
  ...
  function apply(){
    ...
    document.querySelectorAll('.synap-brand-image').forEach(img=>{
      const source='synap-logo-'+mode+'.png?v=1.0.0-ui-fix1';
  ...
  css('compact.css?v=1.0.0-day-audio1','compact','brand2');
