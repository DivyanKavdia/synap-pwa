(function () {
  ...
  const APP_SHELL_REVISION = "1.0.0-shell165-parallel-voice";
  ...
  function disconnectGatt(reason, device = bluetoothDevice) {
    ...
    log("App requested GATT disconnect", { reason, state: appState,
      visibility: document.visibilityState });
    // Hey Snap remains device-owned across the link. Detach only the browser
    // voice-result listener before this GATT connection is torn down.
