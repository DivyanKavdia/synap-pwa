...
(function(root){
  ...
  let selected='ask',section,tablist;
  ...
  function mount(){
    ...
    if(!section){
      ...
      section.innerHTML='<div class="section-heading"><h2 id="myActionsTitle">My actions</h2></div><div class="actions-tabs" role="tablist" aria-label="My actions"></div>';
    ...
    for(const [id] of panels){
      ...
      if(section.contains(panel))continue;
      ...
      (document.getElementById('myActionsBody')||section).appendChild(panel);
    }
