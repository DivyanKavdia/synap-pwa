...
const UI_RECOVERY_REVISION='1.0.0-chakshu-media1';
const CACHE_REVISION='1.0.0-shell97-chakshu-media';
const CACHE_NAME=`synap-pwa-${CACHE_REVISION}`;
const APP_SHELL=[
  './chakshu-store.js','./chakshu-transfer.js','./chakshu-media.js','./chakshu-library.js','./chakshu-library.css',
