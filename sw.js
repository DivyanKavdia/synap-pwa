...
const CACHE_REVISION='1.0.0-shell38-branding';
...
const APP_SHELL=[
  ...
  './ai-providers.js','./sleep-state-guard.js','./recording-bridge.js','./transcript-repair.js','./manifest.webmanifest','./logo.webp','./synap-logo.svg','./icon.svg','./icon-192.png','./icon-512.png',
