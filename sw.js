...
const UI_RECOVERY_REVISION='1.0.0-shell157-experimental-voice';
const CACHE_REVISION='1.0.0-shell157-experimental-voice';
const CACHE_NAME=`synap-pwa-${CACHE_REVISION}`;
const APP_SHELL=[
  './devices/chakshu/player.js','./devices/chakshu/capture-preview.js',
  './devices/chakshu/store.js','./devices/chakshu/transfer.js','./devices/chakshu/media.js','./devices/chakshu/library.js','./devices/chakshu/voice.js','./devices/chakshu/library.css',
  ...
  './synap-mark-olive-light.svg','./synap-mark-olive-dark.svg','./synap-mark-blue-light.svg','./synap-mark-blue-dark.svg','./synap-mark-pink-light.svg','./synap-mark-pink-dark.svg','./synap-mark-lavender-light.svg','./synap-mark-lavender-dark.svg',
  './ai-providers.js','./sleep-state-guard.js','./recording-bridge.js','./transcript-repair.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png',
