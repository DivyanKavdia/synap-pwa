...
Synap receives pendant audio over Bluetooth, saves it locally, builds searchable memory and manages firmware updates. Chakshu adds a camera, a photo/video library and local voice commands. The browser is served directly from this repository; firmware lives in [synap-firmware](https://github.com/DivyanKavdia/synap-firmware).
...
| Chakshu / XIAO ESP32S3 Sense | Same audio workflow using onboard PDM           | Photos, timestamped video with separate audio, SD capture/import and local voice commands |
