/* Today processing status and firmware discovery notices. */
(function(root){
'use strict';
const DB='dk-pendant-recordings',TODAY_PIPELINE_ID='todayMemoryPipeline',STYLE_ID='synap-today-pipeline-style';
